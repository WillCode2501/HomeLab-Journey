...
8. **Network configuration:**
   ...
   - IP address: assign a static IP (e.g., `192.168.50.133`)
   - Gateway: your router IP (e.g., `192.168.50.1`)
...
| Item | Value |
|---|---|
| Proxmox Web UI | `https://192.168.50.133:8006` |
| Login | `root` / your password |
| SSH | `ssh root@192.168.50.133` |
